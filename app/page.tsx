...
const branches = [
  { id: "branch-prime", name: "Prime Continuity", integrity: 94, status: "active" },
  { id: "branch-evacuation-fails", name: "Evacuation Failure Variant", integrity: 82, status: "requires review" },
  { id: "branch-ren-discloses", name: "Ren Disclosure Variant", integrity: 89, status: "active" }
];
